    ...
    <header className="bg-slate-900 border-b border-slate-800 text-white sticky top-0 z-40 shadow-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3 min-w-0">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-indigo-600 via-indigo-500 to-cyan-400 p-0.5 shrink-0 shadow-xs">
        ...
        <div ref={actionsRef} className="flex items-center gap-2 sm:gap-3 shrink-0">
          ...
          <div className="relative">
            ...
            {showSamplesDropdown && (
              <div className="absolute right-0 mt-2 w-72 bg-slate-900 border border-slate-700 rounded-2xl shadow-xl p-2 z-50 text-xs">
          ...
          <div className="relative">
            ...
            {showHistoryDropdown && (
              <div className="absolute right-0 mt-2 w-80 bg-slate-900 border border-slate-700 rounded-2xl shadow-xl p-2 z-50 text-xs max-h-96 overflow-y-auto">
