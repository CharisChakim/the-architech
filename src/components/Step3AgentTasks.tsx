...
export const Step3AgentTasks: React.FC<Step3AgentTasksProps> = ({ session, onUpdateSession }) => {
  ...
  const buildBundledMarkdown = (): string => {
    ...
    md += `> Generated by AI Plan Architect on ${new Date().toLocaleDateString()}\n`;
  ...
  return (
    <div className="space-y-8 pb-12">
      {/* Introduction Banner */}
      <div className="bg-gradient-to-r from-indigo-950 via-slate-900 to-emerald-950 text-white rounded-3xl p-6 sm:p-8 shadow-xl border border-indigo-500/20 relative overflow-hidden">
        ...
        <div className="space-y-8 animate-in fade-in duration-300">
            ...
            <div className="flex items-center gap-2 bg-slate-100 p-1 rounded-2xl">
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-semibold transition-all ${
                  viewMode === "kanban" ? "bg-white text-indigo-900 shadow-xs" : "text-slate-600 hover:text-slate-900"
                }`}
              >
              ...
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-semibold transition-all ${
                  viewMode === "list" ? "bg-white text-indigo-900 shadow-xs" : "text-slate-600 hover:text-slate-900"
                }`}
              >
          ...
          {viewMode === "kanban" && (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {/* Column 1: To Do */}
              <div className="bg-slate-100/70 border border-slate-200 rounded-3xl p-4 space-y-3">
              ...
              <div className="bg-indigo-50/50 border border-indigo-200/80 rounded-3xl p-4 space-y-3">
                ...
                <div className="space-y-3">
                  ...
                  {inProgressTasks.length === 0 && (
                    <div className="p-6 text-center text-xs text-slate-400 italic bg-white/50 rounded-2xl border border-dashed border-slate-200">
              ...
              {/* Column 3: Done */}
              <div className="bg-emerald-50/50 border border-emerald-200/80 rounded-3xl p-4 space-y-3">
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="flex items-center gap-1.5 px-3 py-1.5 bg-white border border-slate-200 text-slate-700 hover:bg-slate-100 rounded-xl text-xs font-semibold transition-all shadow-2xs"
                        >
                          ...
                          <div>
                            ...
                            <div className="text-slate-700 font-medium">
                              {task.dependencies && task.dependencies.length > 0 ? (
                                ...
                                <span className="text-slate-400">Tidak ada dependensi</span>
                              )}
                            </div>
                          </div>
                        </div>
      ...
      {selectedTaskForModal && (
        <div className="fixed inset-0 z-50 bg-slate-900/80 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl max-w-2xl w-full max-h-[85vh] overflow-y-auto p-6 sm:p-8 space-y-6 shadow-2xl border border-slate-200 animate-in zoom-in-95 duration-150">
