...
export const ExportModal: React.FC<ExportModalProps> = ({ isOpen, onClose, session }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 backdrop-blur-xs p-4 overflow-y-auto">
      <div className="bg-white rounded-2xl shadow-lg border border-slate-200 w-full max-w-lg overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full flex items-center justify-between p-3.5 bg-slate-50 border border-slate-200 hover:bg-slate-100/80 rounded-2xl text-left transition-all disabled:opacity-40"
            >
            ...
            <button
              ...
              className="w-full flex items-center justify-between p-3.5 bg-indigo-50 border border-indigo-200 hover:bg-indigo-100/80 rounded-2xl text-left transition-all"
            >
              <div className="flex items-center gap-3">
